...
ratio_table <- readRDS("data/ratio_table_anaero.RDS.RDS")
totals_list <- .generate_pairwise_totals_list(ratio_table)
dispersion_quartile_table <- readRDS("data/quartiles-anaero.RDS.RDS")
...
filename_1 <- "output/parametric-scenario-table-anaero.RDS"
filename_2_prefix <- "output/parametric-anaero-scenario-"
